--- 
title: "Retrospective analysis of calving interval data from New Zealand dairy herds"
subtitle: EpiVets study number LA2046
author: 
- Greg Chambers
- EpiVets
...
output: 
  bookdown::word_document2:
    encoding: "UTF-8"
    reference_docx: "EpiVets_word_template2.docx"
    fig_caption: yes
    toc: yes
    toc_depth: 2
site: bookdown::bookdown_site
#bibliography: []
#csl: new-zealand-veterinary-journal.csl
#link-citations: no
...
``` {r index-setup, echo=F, message=F, warning=F}
############################################################################################################################################
# General setup
library(plyr)
library(reshape)
